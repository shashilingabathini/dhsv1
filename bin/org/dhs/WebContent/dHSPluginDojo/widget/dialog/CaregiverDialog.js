define([
	...
	"dojo/text!./templates/CaregiverDialog.html",
	...
	return declare("dHSPluginDojo.widget.dialog.CaregiverDialog",[BaseDialog],{
		
		contentString: template,
		widgetsInTemplate: true,
        postCreate : function() {
			this.inherited(arguments);
			this.setTitle("Caregiver Search");
		...
		checkMandatory :  function() {
		    ...
		    if(this._lastName.get("value") === ""  && this._ssn.get("value") === "" && this._dob.get("value") === null && this._careGiverId.get("value") === "") {
